...
function AddThreadButton() {
  return (
    <Link to="/thread/new" className='fixed z-90 bottom-10 right-8'>
      <button className="p-0 w-12 h-12 bg-blue-600 rounded-full hover:bg-blue-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none">
